...
void pins_model_init(model_t m) {
    ...
    GBchunkPut(m, action_type, chunk_str("switch_fox"));
    GBchunkPut(m, action_type, chunk_str("switch_goose"));
    GBchunkPut(m, action_type, chunk_str("switch_beans"));
    GBchunkPut(m, action_type, chunk_str("switch_man"));
