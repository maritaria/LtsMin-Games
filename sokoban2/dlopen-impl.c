...
void pins_model_init(model_t m) {
    ...
    GBchunkPut(m, action_type, chunk_str("push_right"));
    GBchunkPut(m, action_type, chunk_str("walk_up"));
    GBchunkPut(m, action_type, chunk_str("push_up"));
    GBchunkPut(m, action_type, chunk_str("walk_down"));
    GBchunkPut(m, action_type, chunk_str("push_down"));
